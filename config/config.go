...
const N  = K + M
var NumOfMB = 1
const InnerBandWidth int = 200 * MB / 8   //200Mbps
const OuterBandWidth = InnerBandWidth / 5 //40Mbps
var BlockSize = MB * NumOfMB              //1MB
...
const TestFileSize = 10 * 1024 * MB
var MaxBlockIndex = TestFileSize / BlockSize - 1
const NumOfAlgorithm int32 = 9 //采用3种算法执行相同任务
var Policies = []string{"Base", "CAU", "CAU_DB", "MultiD", "MultiDB", "TUpdateD", "TUpdateB", "TUpdateDB", "TUpdateFB" }
